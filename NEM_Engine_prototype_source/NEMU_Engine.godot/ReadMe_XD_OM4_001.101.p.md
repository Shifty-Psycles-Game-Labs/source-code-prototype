...
This file combines an archived prototype README, public-safe technical notes, research appendices, and later grant-drafting material. The sections are grouped as follows:

1. **Prototype overview** — status, purpose, architecture, roadmap, risks, and evaluation criteria.
2. **Public-safe technical reference** — operator taxonomy, admissibility, discrete implementation, Godot API sketches, and integration maps.
3. **Research appendices** — mathematical summaries, visualisation notes, cognitive systems, coupling models, performance notes, and future directions.
4. **Archived drafting notes** — later planning and grant language retained for historical reference. This material is not part of the validated prototype specification.

> **Editorial status:** This is an archived working document. Some later sections repeat earlier material or describe proposed functionality rather than implemented behaviour. Treat claims about stability, performance, physics, cognition, or commercial readiness as design goals unless they are backed by current source code or reproducible measurements.
